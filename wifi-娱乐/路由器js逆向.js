function NiceScroll(a) {
    ...
    "function" != typeof this.init && (NiceScroll.prototype.init = function () {
        ...
        if ("object" == typeof a)
            for (var b in a) this.sbStyle[b] = a[b]
    }, NiceScroll.prototype.scrollTipSet = function (a) {
        if ("object" == typeof a)
            for (var b in a) this.stStyle[b] = a[b]
        ...
        this.sb.style.visibility = "none" == this.ta.style.display || "hidden" == this.ta.visibility ?
            "hidden" : "visible"
    }, NiceScroll.prototype._check = function () {
        null == id(this.taId) ? (window.clearTimeout(this.checkTt),
            this.sb.parentNode.removeChild(this.sb)) : !1 != this.enabled && (!1 == checkInHorize(this.ta) ?
            this.sb.style.display = "none" : (this.sb.style.display = "block", 0 >= parseInt(this.ta
                .offsetHeight) && (this.sb.style.visibility = "hidden"), this._reset()))
    }, NiceScroll.prototype._getWheelDelta = function (a) {
        a = a || window.event;
        return a.wheelDelta ? window.opera && 9.5 > window.opera.version ? -a.wheelDelta : a.wheelDelta : 40 * -
            a.detail
        ...
        var d = !1;
        this.wtId ? (this.wtCounter = (d = 0 > (this.woSpeed ^ a)) ? b : 50 > this.wtCounter + b ? this
            .wtCounter + b : 50, this.wSpeed = d ? a : 1.05 * this.wSpeed) : (this.wtCounter = b, this
            .woSpeed = this.wSpeed = a, this._wheelAnimateHandle())
    },
...
function DateControl(a, c) {
    ...
    this.cellPadding = 1;
    void 0 == DateControl.prototype.init && (DateControl.prototype.hourStr = label.lHour, DateControl.prototype
        .weekDayNum = 7, DateControl.prototype.lineStr = "-", DateControl.prototype.selTag = "selTag", DateControl
        .prototype.cellBorderWidth = 1,
        DateControl.prototype.iCellIndex = 0, DateControl.prototype.weekArray = [label.Mon, label.Tue, label.Wen,
        ...
        if (!1 != a instanceof Array && void 0 != a && a.length == this.weekDayNum)
            for (var h = 0; h < this.weekDayNum; h++) {
                e = this.table.rows[h];
                c = a[h];
                for (var k = 0; 24 > k; k++) f =
                    e.cells[k], f = f.childNodes[g], void 0 != c ? (this._setSel(f, c % 2), c >>= 1) : this
                    ._setSel(f, 0)
            }
        ...
        var a, c, e = this.weekDayNum,
            f = this.table.rows;
        this.selDate = [0, 0, 0, 0, 0, 0, 0];
        for (var g = 0; g < e; g++) {
            c = f[g];
            for (var h = 0; 24 > h; h++) a = c.cells[h], a = a.childNodes[0], a = parseInt(a.getAttribute(
                "sel")), 1 == a && (this.selDate[g] += Math.pow(2, h))
        }
        return this.selDate
    }, DateControl.prototype._dateConInit =
        function () {
        ...
        for (var g = 0; 24 >= g; g++) c = document.createElement("li"), 24 != g ? (e = document.createElement(
            "span"), e.innerHTML = g, c.appendChild(e), c.style.width = this.cellWidth + 2 * this
            .cellPadding + this.cellBorderWidth + "px", e.onclick = function (a) {
            return function () {
                for (var b = f.table.rows, c = b.length, d = f.iCellIndex, e = 1, g = 0; g < c && (
                    e &= parseInt(b[g].cells[a].childNodes[d].getAttribute("sel")),
                    0 != e); g++) ;
                e = 1 - e;
        ...
        for (var f = 0, g = this.weekDayNum; f < g; f++) c = document.createElement("li"), c.style.height = this
            .cellHeight + 2 * this.cellPadding + this.cellBorderWidth + "px", c.style.lineHeight = this
                .cellHeight +
            2 * this.cellPadding + this.cellBorderWidth + "px", c.innerHTML = this.weekArray[f], c.onclick =
            function (a) {
                return function () {
                    for (var b = e.table.rows[a].cells, c = e.iCellIndex, d = 1, f = 0, g = b.length; f <
                    g && (d &= parseInt(b[f].childNodes[c].getAttribute("sel")), 0 != d); f++) ;
                    d = 1 - d;
                    f = 0;
        ...
        a.style.backgroundColor = 1 == c ? this.cellSeColor :
            this.cellDeColor
        ...
        for (var a, c, e, f, g = this, h = 0, k = this.weekDayNum; h < k; h++) {
            ...
            for (var m = 0; 24 > m; m++) e = c.insertCell(-1), e.style.padding = this.cellPadding + "px", e
                .className = "weekTd", f = document.createElement("i"), f.className = "tableICell", f.style
                .height = this.cellHeight + "px", f.style.width = this.cellWidth + "px", e.appendChild(f), this
                ._setSel(f, 0), void 0 != a ? (this._setSel(f, a % 2), a >>= 1) : this._setSel(f,
                0), f.onmouseover = function (a) {
    ...
    }, DateControl.prototype._dateTableCreate =
        function () {
...
function PageFunc() {
    ...
    this.showCon = function (a) {
        var c = id(a),
            ...
            e;
        for (e in d) b = d[e], void 0 != b.nodeName && "DIV" == b.nodeName.toUpperCase() && b.id != a && setStyle(
            b, {
                display: "none"
            });
        setStyle(c, {
    ...
    this.loginChange = function (a) {
        function c() {
            for (var a in g) f = g[a], void 0 != f.nodeName && "DIV" == f.nodeName.toUpperCase() && f.id != h
                .loginId && f.id != h.coverId && h.setStyle(f, {
                display: d
            });
            h.setStyle(b, {
                display: e
        ...
        emptyNodes(b);
        !0 == a ? (a = $.authRltObj.code,
            ESYSRESET == a ? (!0 == OS.portable && !1 == OS.iPad ? loadLgLessPage("PhoneSetPwd.htm", "Con",
                void 0, {
                    bRecordLoadPage: !1
                }) : (document.body.style.height = "auto", loadPage("LoginChgPwd.htm", "Login", c, {
                bRecordLoadPage: !1
            })), emptyNodes(id("Con")), setLoadPage("Content.htm", "Con")) : ESYSLOCKEDFOREVER == a ||
            ESYSLOCKED == a ? (document.body.style.height = "auto", $.queryAuthLog(function (a) {
                ...
                !0 == OS.portable && !1 == OS.iPad && !1 == phoneSet.bContinuePCSet ? loadLgLessPage("PhoneApp.htm",
                    "Con", void 0, {
                        bRecordLoadPage: !1
                    }) : (document.body.style.height = "auto", loadPage("Login.htm", "Login", c, {
                    bRecordLoadPage: !1
                }))) : (document.body.style.height = !0 == OS.portable && !1 == OS.iPad && !1 == phoneSet
            .bContinuePCSet ? "100%" : _gPageHeightLg + "px", this.loadPageData.options = this.loadPageData
            .options || {}, this.loadPageData.options.bRecordLoadPage = !1, this.loadPage(this.loadPageData.url,
            this.loadPageData.id,
            function () {
                "function" ==
                typeof h.loadPageData.handle && h.loadPageData.handle()
    ...
    this.getLgPwd = function () {
        try {
            $.pwd = sessionLS.getItem(this.LGKEYSTR), 0 == gCloudAccountBR.pwdLen && (gCloudAccountBR.pwdLen =
                parseInt(sessionLS.getItem(this.LGKEYLEN)))
        } catch (a) {
        }
    };
    ...
    this.iFrmOnload = function (a, c, b) {
        ...
        try {
            d = a.contentWindow ?
                a.contentWindow.document.body ? a.contentWindow.document.body.innerHTML : null : a.contentDocument
                    .document.body ? a.contentDocument.document.body.innerHTML : null;
    ...
    this.pageRedirect = function () {
        ...
        USER_GROUP_REMOTE != $.authRltObj.group && !1 == /^((http:\/\/)*(\d{1,3}\.){3}\d{1,3})/g.test(a) &&
        0 > a.indexOf(gDomainDNS) && !1 == $.local && (window.top.location.href = $.httpTag + gDomainDNS)
    };
            ...
            callBack: function () {
                this.loadExternResource({
                    ...
                    callBack: function () {
                        ...
                        this.compatibleShow();
                        this.localSgInit();
                        !0 == $.local ? this.loadPage("Content.htm", "Con") : !1 ==
                        /^((http:\/\/)*(\d{1,3}\.){3}\d{1,3})/g.test(b) && 0 <= b
                            .indexOf(gDomainDNS) ? (b = {}, b[uciSystem.actionName
                            .getDomainArray] = null, $.action(b, function (a) {
                            ENONE == a[ERR_CODE] ? (a = a[uciSystem.dynData
                                .domainArray], 1 < a.length ? (this
                                .gDomainDetectArr = a, this
                                .loadLgLessPage("RouterSelect.htm",
                                    "Con", void 0, {
                                        bRecordLoadPage: !1
                                    })) : this.loadPage("Content.htm",
                                "Con")) : this.loadPage("Content.htm",
                                "Con")
                        })) : this.loadPage("Content.htm",
                            "Con")
                    }
    ...
    this.loadExternResource = function (a) {
        ...
        d = c.callBack;
        if (void 0 != a)
            for (var h in a) c = document.createElement("link"), c.rel = "stylesheet", c.href = a[h].url, f
                .appendChild(c);
        if (void 0 != b) {
            var k;
            ...
            c.type =
                "text/javascript";
            if (void 0 != d)
                for (h in e = void 0 != c.readyState, k = function (a) {
                    b[a].loadState = !0;
                    for (var c in b)
                        if (!1 == b[c].loadState) return;
                    d()
                }, b) b[h].loadState = !1;
            for (h in b) c = document.createElement("script"), c.type = "text/javascript", void 0 != d && (e ? c
                .onreadystatechange = function (a) {
                return function () {
                    if ("loaded" == this.readyState || "complete" == this.readyState) this
                        .onreadystatechange = null, k(a)
                }
...
function Cover() {
    ...
    this.showCoverB = function (a, c) {
        ...
        void 0 == b && (b = document.createElement("div"),
            b.id = this.CoverIdB, document.body.appendChild(b));
        this.setStyle(b, {
            display: "block",
            visibility: "visible"
        });
...
function Style() {
    ...
    this.getNodeDefaultView = function (a, c) {
        ...
        if (!a) return null;
        try {
            return b = a.currentStyle ? a.currentStyle : document.defaultView.getComputedStyle(a, null), void 0 !=
            c ? b[c] : b
        } catch (d) {
        }
    }
...
function Explorer() {
    ...
    this.getIEInfo = function () {
        ...
        !1 != isIE && (6 >= isIE ? this.isIESix = !0 : 7 == isIE ? this.isIESeven = !0 : 9 <= isIE && (this
            .isIENormal = !0), 10 >= isIE && (this.isIETenLess = !0), this.isIE = !0)
    };
    this.compatibleShow = function () {
        if (!0 == this.isIESix) {
            var a, c, b, d, e;
            0 <= document.cookie.indexOf("ieSixClosed") || (a = $("div.ieSixCompatible"),
            void 0 == a[0] && (a = el("div"), a.className = "ieSixCompatible", c = el("div"), c.className =
                "ieSixCpCon", b = el("i"), d = el("span"), d.className = "spanNote", d.innerHTML = label
                .IESixCpTip, e = el("span"), e.className = "spanClose", e.innerHTML = label.iknown, e
                .onclick = function () {
                document.cookie = "ieSixClosed=true";
                a.style.visibility = "hidden";
                a.style.top = "-9999px"
            }, c.appendChild(b), c.appendChild(d), c.appendChild(e), a.appendChild(c), document.body
                .appendChild(a)))
        }
    };
    this.createGroupRadio = function (a) {
        ...
        !0 == this.isIE && !1 == this.isIENormal ? c = document.createElement("<input name='" + a + "' />") : (c =
            document.createElement("input"), c.name = a);
        return c
    };
    this.getIEInfo()
}
...
function Tool() {
    ...
    this.replaceJSP = function (a) {
        var c = null,
            ...
            c = d.exec(a);
        try {
            for (; null != c;) b = language[c[1]][c[2]], a = a.replace("{%" + c[1] + "." + c[2] + "%}", b), c = d
                .exec(a)
        } catch (e) {
        }
        try {
    ...
    this.getoffset = function (a, c) {
        for (var b = a, d = {
            ...
            left: 0
             ...
             c;) d.left += parseInt(b.offsetLeft), d.top += parseInt(b.offsetTop), b = b.offsetParent;
        return d
    };
    ...
    this.getChildNode = function (a, c, b) {
        ...
        f = c.split(" ");
        c = f[0];
        for (var g = f[1], h = 0, k = a.length; h < k; h++) f = a[h], 1 == f.nodeType && f.tagName.toLowerCase() ==
        c && (void 0 != g && f.type == g ? (d[e] = f, e++) : void 0 == g && (d[e] = f, e++));
        return void 0 != b ? d[b] : d[0]
    };
    this.checkInHorize = function (a) {
        for (; null != a && "HTML" != a.nodeName.toUpperCase();) {
            if ("hidden" == this.getNodeDefaultView(a, "visibility") || "none" ==
                this.getNodeDefaultView(a, "display")) return !1;
            a = a.parentNode
        }
        return !0
    };
    this.setUrlHash = function (a, c) {
        ...
        var f = location.href;
        d = location.hash;
        void 0 != a && void 0 != c && 0 != a.length && (0 != d.length ? (e = d.indexOf(a), 0 <= e ? (b = d
            .substring(0, e), d = d.substring(e), e = d.indexOf("#"), 0 < e ? (d = d.substring(e), d =
            b + a + "=" + c + d) : d = b + a + "=" + c) : ("#" != d.substring(d.length - 1) && (b =
            "#"), d += b + a + "=" + c), location.href = f.substring(0, f.indexOf("#")) + d) : f
            .lastIndexOf("#") == f.length - 1 ? location.href += a + "=" + c : location.href += "#" + a + "=" +
            c)
    };
    ...
    this.getStrInMax = function (a, c) {
        ...
        for (var f = 1; f <= c; f++) {
            d = a.charAt(e);
            if ("" == d) break;
            1 < getDisplayStrLen(d) ? (f += getDisplayStrLen(d) - 1, b += d, beCut = !0) : !0 == /[A-Z]/g.test(d) ?
                (f++, b += d, beCut = !0) : b += d;
            e++
        }
        return b + "..."
    ...
    this.escapeDBC = function (a) {
        ...
        if (!a) return "";
        if (window.ActiveXObject) return execScript('SetLocale "zh-cn"', "vbscript"), a.replace(/[\d\D]/g,
            function (a) {
                window.vbsval = "";
    ...
    this.orgAuthPwd = function (a) {
        return this.securityEncode(a, "RDpbLfCPsJZ7fiv",
    ...
    this.netSpeedTrans = function (a) {
        a = parseInt(a);
        a = 1073741824 <=
        a ? (a / 1073741824).toFixed(0) + "GB/s" : 1048576 <= a ? (a / 1048576).toFixed(0) + "MB/s" : (a / 1024)
            .toFixed(0) + "KB/s";
        return a.toString()
    };
...
function Switch(a, c, b) {
    ...
    "function" != typeof Switch.prototype.switchInit && (Switch.prototype.switchInit = function () {
        var a = this.state,
            ...
            c = this.switchCon,
            g = this.switchBg;
        null != c && null != b && (this.rightPos = c.offsetWidth - b.offsetWidth, this.setState(a), this
            .callback && this.callback(a), b.onmousedown = this.draggableBind(), g.onclick = this
            .switchBgClick())
    },
        Switch.prototype.setState = function (a) {
            ...
            c.style.background = 1 == a ? "url(../web-static/images/routerBg.png) -441px -53px no-repeat" :
                "url(../web-static/images/routerBg.png) -424px -52px no-repeat"
...
function HighSet() {
    ...
    this.hsStatSet = function (a,
                               c, b) {
        var d, e;
        void 0 == b ? (d = $("ul.gridStatus")[0], e = $("ul.gridStatus label")[0], statPic = $("ul.gridStatus i")[
            0]) : (d = $("#" + b)[0], e = $("#" + b + " label")[0], statPic = $("#" + b + " i")[0]);
        switch (a) {
            case "null":
    ...
    this.disableBtn = function (a, c) {
        var b = "object" == typeof a ? a : id(a),
            d = b.className;
        b.disabled != c && (b.disabled = c ? !0 : !1, b.className = c ? d.replace("subBtn", "subBtnDis") : d
            .replace("subBtnDis", "subBtn"))
    };
    this.disableClick = function (a, c, b) {
        a = "object" == typeof a ? a : id(a);
        b = null;
        null == a.disableTimes && (a.disableTimes = 0);
        if (!0 == c) return 0 >= a.disableTimes && (a.oldOnClick = a.onclick, a.onclick = null), b = a.oldOnClick, a
            .disableTimes++,
            b;
        a.disableTimes--;
    ...
    this.hsLoading = function (a, c) {
        var b = this.hsLoadingObj,
            d = id(b.subBtnId),
            e, f, g, h, k, m, l;
        null != d && d == b.subBtnObj && (k = d.parentNode, k.style.position = "relative", h = d.offsetWidth, e = d
            .offsetLeft, g = d.offsetTop, f = d.offsetHeight, l = $("#" + b.subBtnId +
            " ~ div.hsLoadingCon")[0], m = $("#" + b.subBtnId + " ~ div.hsLoadingCon img")[0], window
            .clearTimeout(b.handleDelayHd), !0 == a ? (d.style.visibility = "hidden", void 0 == l ? (l = el(
            "div"), l.className = "hsLoadingCon", k.appendChild(l), l.style.width = h + "px", l
            .style.height = f + "px", l.style.top = g + "px", l.style.left = e + "px", m = el("img"), l
            .appendChild(m), m.onload = function () {
            m.style.height = f + "px";
            l.style.visibility = "visible"
        }, m.src = "../web-static/images/" + b.loadImgCol[b.loadImgKey]) : (m.style.height = f +
            "px", l.style.height = f + "px", l.style.width =
            h + "px", l.style.top = g + "px", l.style.left = e + "px", l.style.visibility = "visible")) : b
            .handleDelayHd = window.setTimeout(function () {
            b.subBtnId = "";
            d.style.visibility = "visible";
    ...
    this.hsSwitchState = function (a, c) {
        ...
        null != b && (1 == c ? (b.innerHTML = statusStr.opened, b.style.color = "#86B157") : (b.innerHTML =
            statusStr.closed, b.style.color = "#FB6E52"))
    }
}
...
function ShowTips() {
    ...
    this.showAlert = function (a, c, b, d) {
        this.showCover(function () {
            var e = id("Error"),
                f = id("hsErr"),
                g, h = this;
            !0 == isIESix ? alert(a) : (this.shAltObjOrId = c, g = $("div.hsTip input.subBtn")[0], null ==
            f && (f = document.createElement("div"), f.id = "hsErr", f.className = "hsTip", g =
                document.createElement("p"), g.className = "detail", f.appendChild(g), g = document
                .createElement("input"), g.type = "button", g.className = "subBtn ok", g.value = btn
                .ok, f.appendChild(g), e.appendChild(f)), getChildNode(f,
                "p").innerHTML = a, b && (f.style.marginLeft = "280px"), g.onclick = function () {
                "function" == typeof d && d();
                h.closeAlert(!0)
                ...
                position: "absolute"
            }), !1 == OS.iPhone && !1 == OS.iPad && g.focus(), this.alertTimeHd = $.setTimeout(
                function () {
                    h.closeAlert()
                }, 3E4))
        })
    ...
    this.closeAlert = function (a) {
        this.hideCover(function () {
            var c = id("Error"),
                b = this.shAltObjOrId;
            if (null != c)
                if (c.style.top = "-9999px", c.style.visibility =
                    "hidden", clearTimeout(this.alertTimeHd), this.alertTimeHd = null, !0 != a || void 0 ==
                b || "object" != typeof b && 0 == b.length) this.shAltObjOrId = "";
                else try {
    ...
    this.showAlertC = function (a, c, b, d) {
        this.showCover(function () {
            ...
            !0 == isIESix ? alert(a) : (this.shAltObjOrId = c, g = $("div.hsTip input.subBtn")[0], null ==
            f && (f = document.createElement("div"), f.id = "hsErr", f.className = "hsTip", g =
                document.createElement("i"), g.className = "alertImg", f.appendChild(g), g =
                document.createElement("p"), g.className = "detailImg", f.appendChild(g), g =
                document.createElement("input"), g.type = "button", g.className = "subBtn ok",
                g.value = btn.ok, f.appendChild(g), e.appendChild(f)), getChildNode(f, "p")
                .innerHTML = a, b && (f.style.marginLeft = "280px"), g.onclick = function () {
                d && d();
                h.closeAlertC(!0)
            }, e.style.visibility = "visible", e.style.display = "block", e.style.top = "90px", !
                1 == OS.portable ? setStyle(e, {
    ...
    this.closeAlertC = function (a) {
        this.hideCover(function () {
            var c = id("Error"),
                b = this.shAltObjOrId;
            if (null != c)
                if (c.style.top = "-9999px", c.style.visibility = "hidden", clearTimeout(this.alertTimeHd),
                    this.alertTimeHd = null, !0 != a || void 0 == b || "object" != typeof b && 0 == b.length
                ) this.shAltObjOrId = "";
                else try {
                    "object" != typeof b && (b = id(b)), b.focus(), b.select()
                } catch (d) {
    ...
    this.showConfirm = function (a, c, b, d) {
        this.showCover(function () {
            ...
            !0 == isIESix ? (e = confirm(a), this.closeConfirm(), c(e)) : (null == f && (f = document
                .createElement("div"),
                f.id = "hsConf", f.className = "hsTip", g = document.createElement("p"), g
                .className = "detail", f.appendChild(g), g = document.createElement("input"), g
                .type = "button", g.className = "subBtn ok", g.value = k, f.appendChild(g), g =
                document.createElement("input"), g.type = "button", g.className = "subBtn cancel", g
                .value = m, f.appendChild(g), e.appendChild(f)), g = $("#hsConf input"), g[0]
                .value = k, g[0].onclick = function () {
                h.closeConfirm();
                c(!0)
            }, g[1].value = m, g[1].onclick = function () {
                h.closeConfirm();
                c(!1)
            }, getChildNode(f, "p").innerHTML = a,
                e.style.visibility = "visible", e.style.display = "block", e.style.top = "90px", !1 ==
            OS.portable ? setStyle(e, {
                position: "fixed"
            }) : setStyle(e, {
                position: "absolute"
            }))
    ...
    this.showConfirmB = function (a, c) {
        this.showCover(function () {
            var b = id("Confirm"),
                d = id("hsConf"),
                e, f = this;
            !0 == isIESix ? (b = confirm(a), this.closeConfirm(), c(b)) : (null == d && (d = document
                .createElement("div"), d.id = "hsConf",
                d.className = "hsTip", e = document.createElement("i"), e.className = "confirmImg",
                d.appendChild(e), e = document.createElement("p"), e.className = "detailImg", d
                .appendChild(e), e = document.createElement("input"), e.type = "button", e
                .className = "subBtn ok", e.value = btn.cloudRetry, d.appendChild(e), e = document
                .createElement("input"), e.type = "button", e.className = "subBtn cancel", e.value =
                btn.cloudBack, d.appendChild(e), b.appendChild(d)), e = $("#hsConf input"), e[0]
                .onclick = function () {
                f.closeConfirm();
                c(!0)
                ...
                f.closeConfirm();
                c(!1)
            }, getChildNode(d, "p").innerHTML = a, b.style.visibility = "visible", b.style.display =
                "block", b.style.top = "90px", !1 == OS.portable ? setStyle(b, {
                position: "fixed"
            }) : setStyle(b, {
                position: "absolute"
            }))
    ...
    this.showNote = function (a, c) {
        var b = id(a);
        void 0 != b && (void 0 != c && ($("#" + a + " div.noteCon p")[0].innerHTML = c), b.style.visibility =
            "visible")
    };
    this.showNoteB = function (a, c,
                               b) {
        var d = id(a),
            e;
        void 0 != d && (e = $("#" + a + " i.tip")[0], a = $("#" + a + " span")[0], void 0 != c && (a.innerHTML = c),
            a.className = void 0 != b ? b : "note", e.style.visibility = "visible", d.style.visibility =
            "visible")
    };
    ...
    this.showLoading = function (a, c, b, d) {
        ...
        showCover(function (e) {
            ...
            e = $("#" + e.id);
            g = 0.7;
            void 0 != b && (f = b.loadConClass, h = b.loadClass, k = b.coverLoadingClass,
                m = b.detailClass, g = b.coverOpacity || 0);
            e.css("opacity", g);
            g = el("div");
            ...
            e.appendChild(f);
            void 0 == k ? (h = el("img"), h.className = "coverLoading", h.src =
                "../web-static/images/loadingRouteSet.gif") : (h = el("i"), h.className = k);
            f.appendChild(h);
            k = el("p");
            ...
            d = void 0 == d ? !0 : d;
            !0 ==
            d && (m = el("input"), m.type = "button", m.className = "coverLoadClose cancelBtn", m
                .value = btn.cancel, m.onclick = function () {
                closeLoading(c)
            }, f.appendChild(m))
        })
    };
    ...
    this.showPhWzdAlert = function (a, c) {
        this.showCover(function () {
            var b, d, e, f = this;
            b = id("phWzdAlertCon");
            null == b ? (b = document.createElement("div"), b.className = "phWzdAlertCon", b.id =
                "phWzdAlertCon", document.body.appendChild(b),
                d = document.createElement("img"), d.src = "../web-static/images/redWarn.png", b
                .appendChild(d), d = document.createElement("p"), b.appendChild(d), e = document
                .createElement("label"), b.appendChild(e), e.innerHTML = btn.confirm) : (d = $(
                "#phWzdAlertCon p")[0], e = $("#phWzdAlertCon label")[0]);
            b.style.top = "150px";
...
function Select() {
    ...
    this.selectInit = function (a, c, b, d, e, f) {
        function g(a) {
            for (var b, c, d = a.childNodes, e = 0, f = d.length; e < f; e++) c = d[e], b = c.childNodes[0].style
                .visibility, c.style.backgroundColor = "visible" == b ? v : x, c.style.color = "visible" == b ? w :
                p;
            a.style.visibility = "hidden";
            a.style.top = "-9999px";
        ...
        function h(b) {
            ...
            if (3 != b.childNodes[0].nodeType) {
                c.value = b.valueStr;
                g.value = b.valueStr;
                for (var h = 0, k = f.length; h < k; h++) f[h].childNodes[0].style.visibility =
                    "hidden", f[h].style.backgroundColor = x, f[h].style.color = p;
        ...
        function k(a) {
            for (var b = 0, c = a.length; b < c; b++) n = a[b], B = htmlEscape(getStrInMax(n.str.toString(),
                F)), t = "hidden", l = document.createElement("li"), void 0 == n.value && b == z || z == n
                .value ? (t = "visible", q.innerHTML = B, q.value = z, r.value = z, l.style.backgroundColor = v, l
                .style.color = w, l.innerHTML = "<span class='selCross' style='visibility:" + t + "'></span>" +
                B) : (l.style.color = p, l.innerHTML = "<span class='selCrossOut' style='visibility:" + t +
                "'></span>" + B), l.title = n.str, l.valueStr = void 0 != n.value ? n.value : b, l.className =
                ...
                if ("span" != a.tagName.toLowerCase()) {
                    ...
                    for (var d = 0, e = b.length; d < e; d++) c = b[d], c.style.backgroundColor = x, c.style
                        .color = p, c = getChildNode(c, "span"), c.className = "selCrossOut";
        ...
        var C = 1001,
            D = 3,
            E = 3;
        void 0 != f && (s = f.className, x = f.colorN, v = f.colorC, p = f.fontColorN, w = f.fontColorC, A = f
            .valueColor, G = f.valueDisColor, b = void 0 == f.scrollBg ? b : f.scrollBg, C = void 0 == f
            .scrollZIndex ? C : f.scrollZIndex, D = void 0 == f.scrollMLeft ? D : f.scrollMLeft, E = void 0 == f
            .scrollMTop ? E : f.scrollMTop);
        f = r.parentNode;
        y = $("#" +
            a + " span.value");
        q = y[0];
...
function Help() {
    ...
    this.helpInit = function () {
        var a = id(this.help),
            b, d, e = this;
        0 == a.innerHTML.length && (b = document.createElement("p"), b.className = "helpTop", b.onmousedown = this
            .draggableBind(this.help), a.appendChild(b), d = document.createElement("span"), d.className =
            "helpDes", d.innerHTML = label.help, b.appendChild(d), d = document.createElement("i"), d.onclick =
            function () {
                e.helpClose()
            },
            d.className = "helpClose", b.appendChild(d), b = document.createElement("div"), b.id = "helpDetail",
            a.appendChild(b), b = document.createElement("div"), b.style.display = "none", b.id = this
            .helpContent, document.body.appendChild(b));
    ...
    this.basicAppUpgradeInfoShow = function (a, b, d) {
        ...
        null == e && (e = document.createElement("div"), e.id = "basicAppUpgradeInfo", document.body.appendChild(e),
            f = document.createElement("p"), f.className = "appsHelpTop", f.onmousedown = this.draggableBind(
            this.help), e.appendChild(f), g = document.createElement("span"), g.className = "helpDes", g
            .innerHTML = label.updateNoteStr, f.appendChild(g), g = document.createElement("i"), g.onclick =
            function () {
                e.style.display = "none";
                e.style.top = "-9999px"
            }, g.className = "helpClose", f.appendChild(g), f = document.createElement("div"), f.id =
            "basicAppUpgradeInfoDetail", f.className = "basicAppUpgradeInfoDetail", e.appendChild(f), f =
            new NiceScroll("basicAppUpgradeInfoDetail"), f.scrollTipOpacity(1), f.scrollTipSet({
            background: "#B0CB33"
        }), f.scrollBarSet({
            zIndex: "1004",
            mLeft: "10"
...
function LanDetect() {
    ...
    this.lanDetectHandle = function (a) {
        !1 == $.result.timeout && !1 == this.lanDetectSuccess && (this.lanDetectSuccess = !0, clearTimeout(this
            .lanDetectTimeHd), a())
    };
...
function ProgressBar() {
    ...
    this.initProgBar = function () {
        var a = id("ProgressBar"),
            c, b, d;
        null == a && (a = document.createElement("div"), a.id = "ProgressBar", document.body.appendChild(a), c =
            document.createElement("div"), c.className = "progressBarCon", a.appendChild(c), b = document
            .createElement("div"), b.className = "progressBarPCon", c.appendChild(b), d = document
            .createElement("p"), d.className = "progressBarPercent", b.appendChild(d), b = document
            .createElement("div"),
            b.className = "progressBarBg", c.appendChild(b), d = document.createElement("p"), d.className =
            "progressBarDe", b.appendChild(d), d = document.createElement("p"), d.className = "progressBarDes",
            c.appendChild(d));
        this.progressBar = a;
    ...
    this.progRunning = function (a, c, b) {
        ...
        (function () {
            100 <
            m ? void 0 != b && b() : (!0 == a && (f[0].innerHTML = m + "%"), e.css("width", g + h * m +
                "px"), m++, l.progressBarHd = $.setTimeout(arguments.callee, k))
        })()
    };
    ...
    this.progRunningP = function (a, c, b, d) {
        function e(c) {
            n = parseInt(c.count);
            q = c[ERR_CODE];
            ERR_PERCENT == n ? (t.closeProgBar(), "function" == typeof b && b(!1, q)) : (!0 == a && !1 == isNaN(
                n) && (100 <= n && (n = 100), g[0].innerHTML = n + "%"), k.css("width", m + l * n + "px"),
            100 <= n && "function" == typeof b && b(!0))
        }
...
function BlockGrid() {
    ...
    "function" != typeof BlockGrid.prototype.blockInit && (BlockGrid.prototype.blockInit = function (a) {
        ...
        var c, b;
        for (b in a)
            if (c = a[b], "undefined" != typeof this._ops[b])
                if ("object" != typeof c || c instanceof Array || null == this._ops[b]) this._ops[b] = c;
                else
                    for (var d in c) this._ops[b][d] = c[d]
        ...
        for (var a = $("#" + this._ops.id).find("i"), c = [], b, d = 0; d < a.length; d++) b = this._ops
            .dataInfo[d],
...
function TimeControlSet() {
    ...
    this.netCtrlListCreate = function (a, c, b, d, e) {
        ...
        for (var v in a) {
            ...
            k.innerHTML = !0 == e ? l[r] + label.wlanOn + " / " + l[s] + label.wlanOff : label.limitTime + label
                .colon + l[r] + " - " + l[s];
            h.appendChild(k);
            k = m.createElement("span");
            n = objToWeekList(l);
    ...
    this.objToWeekList = function (a) {
        var c = [],
            b = [uciHostsInfo.optName.mon, uciHostsInfo.optName.tue, uciHostsInfo.optName.wed, uciHostsInfo.optName
                .thu, uciHostsInfo.optName.fri, uciHostsInfo.optName.sat, uciHostsInfo.optName.sun
            ],
            d;
    ...
    this.weekListToObj = function (a, c) {
        var b = [uciHostsInfo.optName.mon, uciHostsInfo.optName.tue, uciHostsInfo.optName.wed, uciHostsInfo.optName
                .thu, uciHostsInfo.optName.fri,
                uciHostsInfo.optName.sat, uciHostsInfo.optName.sun
            ],
            d;
    ...
    this.netControlPanelInit = function (a, c, b) {
        var d = id("VigNetControlCon"),
            ...
            f = [],
            g;
        null == d ? (d = document.createElement("div"), d.className = "VigNetControlCon", d.id = "VigNetControlCon",
            document.body.appendChild(d)) : emptyNodes(d);
        !0 == (void 0 == b ? !1 : b) ? (b = label.beginClock, g = label.endClock) : (b = label.beginTime, g = label
            .endTime);
        d.innerHTML =
            '<div class="vigNetControl" id="vigNetControl"><ul class="netControlLine"><label class="desc">' + label
                .periodDesc +
            '</label><input type="text" class="text timeDesc" id="netControlName" maxlength="32"></ul><ul class="netControlLine"><label class="desc">' +
            b +
            '</label><li class="netControlText"><span class="netSelectSpan"><span id="beginHour" class="select netSelect"><span class="value hsTimeCon"></span><i class="arrow eptArrow"></i></span></span><label>' +
            label.hour +
            '</label></li><li class="netControlText"><span class="netSelectSpan"><span id="beginMinute" class="select netSelect"><span class="value hsTimeCon"></span><i class="arrow eptArrow"></i></span></span><label>' +
            label.minute + '</label></li></ul><ul class="netControlLine"><label class="desc">' + g +
            '</label><li class="netControlText"><span class="netSelectSpan"><span id="endHour" class="select netSelect"><span class="value hsTimeCon"></span><i class="arrow eptArrow"></i></span></span><label>' +
            label.hour +
            '</label></li><li class="netControlText"><span class="netSelectSpan"><span id="endMinute" class="select netSelect"><span class="value hsTimeCon"></span><i class="arrow eptArrow"></i></span></span><label>' +
            label.minute +
            '</label></li></ul><ul class="netControlLine"><label class="desc">' + label.repeat +
            '</label><ul class="netControlWeek" id="netControlWeek"></ul></ul><div class="netControlBtn"><input type="button" class="subBtn eptBtnA" value="' +
            btn.ok + '" id="btnSaveWeek"><input type="button" class="cancelBtn eptBtnA" value="' + btn.cancel +
            '" id="btnCancelWeek"></div></div>';
...
function CloudCommon() {
    ...
    this.cloudPageSetNodes = function (a) {
        ...
        !0 == a ? (b = "block", c = "none", gCloudAccountBR.bodyHeight = parseInt(document.body.offsetHeight),
            document.body.style.height = "auto") : (b = "none", c = "block", document.body.style.height =
            gCloudAccountBR.bodyHeight + "px");
        for (var f in e) d = e[f], void 0 !=
        d.nodeName && "DIV" == d.nodeName.toUpperCase() && (d.id == this.cloudPageId ? setStyle(d, {
            display: b
        }) : "Con" == d.id ? !0 == a ? (d.style.visibility = "hidden", d.style.position = "absolute", d
            .style.top = "-9999px") : (d.style.visibility = "visible", d.style.position = "static", d.style
            .top = "0px") : d.id == this.loginId && d.id == this.coverId || setStyle(d, {
            display: c
        }));
...
function CloudAction() {
    ...
    this._cloudQueryErrHandle = function (a,
                                          c) {
        var b = "";
        switch (parseInt(a)) {
            case ENONE:
    ...
    this._cloudActionQueryStatus = function (a, c, b, d, e) {
        !0 != cloudActionQueryStoped && (!0 == cloudActionStatusQuering && !1 == b ? _cloudGetActnErrHandle(
            EINVLASTOPTIONISNOTFINISHED) : (cloudActionStatusQuering = !1, clearTimeout(
            cloudActionQueryStatusHd), clearTimeout(cloudActionQueryStatusWaitHd),
        ...
        $.action(b, function (a) {
            if (!0 != cloudActionQueryStoped && !0 == _cloudGetActnErrHandle(a[ERR_CODE], c)) {
                ...
                _cloudActionQueryStatus(b.secName.getAccountStat, function (a) {
                    _cloudQueryErrHandle(a[b.fileName][b.secName.getAccountStat][b.optName
                        .errCode]) && (a = {}, a[d.fileName] = {}, a[d.fileName][KEY_NAME] = d
                        .secName.deviceStatus, $.action(a, function (a) {
                        !0 == _cloudGetActnErrHandle(a[ERR_CODE], c) && c(d.optValue
                            .regestStatus == a[d.fileName][d.secName.deviceStatus])
                    }, !0))
                }, !0)
            }
        }, !0)
    ...
    this.cloudAccountUnind = function (a, c) {
        ...
        cloudActionQueryStoped = !1;
        $.action(b, function (b) {
            if (!0 != cloudActionQueryStoped && !0 == _cloudGetActnErrHandle(b[ERR_CODE],
                a)) {
    ...
    this.cloudAccountModifyPwd = function (a, c, b, d, e) {
        ...
        cloudActionQueryStoped = !1;
        $.action(g, function (a) {
            if (!0 != cloudActionQueryStoped)
                if (!0 == _cloudGetActnErrHandle(a[ERR_CODE], b)) {
                    var c = cloudClientStatus;
                    _cloudActionQueryStatus(c.secName.modifyAccountPwd,
                        function (a) {
    ...
    this.getAppsUninstalledInfo = function (a, c, b, d, e) {
        ...
        $.action(g, function (a) {
            if (!0 != cloudActionQueryStoped && !0 == _cloudGetActnErrHandle(a[ERR_CODE], b)) {
                var c = cloudClientStatus;
                _cloudActionQueryStatus(c.secName.getNotInstalledApps,
                    function (a) {
    ...
    this.getAppsCanUpdateInfo = function (a, c, b, d, e) {
        ...
        $.action(g, function (a) {
            if (!0 != cloudActionQueryStoped && !0 == _cloudGetActnErrHandle(a[ERR_CODE], b)) {
                var c = cloudClientStatus;
                _cloudActionQueryStatus(c.secName.getCanUpdateApps,
                    function (a) {
...
function CloudUpgradePush() {
    ...
    this.upgradeFailHdCloudPush = function () {
        "function" == typeof this.upgradeErrCBCloudPush && (this.upgradeErrCBCloudPush(), this
            .upgradeErrCBCloudPush = null)
    };
    this.checkOnlineUpgrading = function (a) {
        var c =
                cloudClientStatus.fileName,
            b = {};
        b[c] = {};
        b[c][KEY_NAME] = cloudClientStatus.secName.clientInfo;
        !0 == $.local ? a() : $.query(b, function (b) {
            ENONE == b[ERR_CODE] ? (b = parseInt(b[c][cloudClientStatus.secName.clientInfo][
                cloudClientStatus.optName.fwDownloadStatus
                ]), uciCloudConfig.optValue.cloudDownloading == b ? onlineUpgradeProgress() : a()) : a()
        })
    };
        ...
        showProgBarP(statusStr.fwDownloading, function (c) {
            ...
            $.query(b, function (b) {
                if (!0 == errHandleCloudPush(b[ERR_CODE])) {
                    ...
                    d.count = uciCloudConfig.optValue.cloudDownloading == f || uciCloudConfig
                        .optValue.cloudComplete == f ? parseInt(b[cloudClientStatus.optName
                        .fwDownloadProgress]) : uciCloudConfig.optValue.cloudOutline == f ?
                        ERR_PERCENT : 0
            ...
            closeProgBar();
            !0 == a ? showProgBar(REBOOT_SECONDS, label.upgrading,
                function () {
    ...
    this.onlineUpgradeCheck = function (a, c, b) {
        function d() {
            ...
            $.query(e, function (e) {
                if (!0 == a(e[ERR_CODE])) switch (parseInt(e[f][cloudClientStatus.secName.checkFwVer][
                    cloudClientStatus.optName.actionStatus
                    ])) {
                    case 0:
                    case 5:
                        "function" == typeof c && c(e[f][cloudClientStatus.secName.checkFwVer][
...
function Phone() {
    this.OS = {
        ...
        checkDeviceMode: function () {
            ...
            if (void 0 != a)
                if (0 <= a.indexOf("Win")) 0 <= c.indexOf("Windows Phone") ? this.portable = this.windows = this
                    .windowsPhone = !0 : (this.windows = !0, this.portable = !1);
                else if (0 <= c.indexOf("NOKIA")) this.portable = this.nokia = !0;
                else if (0 <= c.indexOf("Android")) this.portable = this.android = !0;
                else if (0 <=
                    a.indexOf("iPad")) this.portable = this.iPad = !0;
                    ...
                    if (0 <= a.indexOf("X11") || 0 <= a.indexOf("Linux") && 0 > a.indexOf("arm")) this.unixPC = !0,
                        this.portable = !1
                } else 0 <= c.indexOf("Android") ? this.portable = this.android = !0 : this.portable = 1024 <=
            document.body.clientWidth ||
            1024 <= document.body.clientHeight ? !1 : !0
        }
    };
    this.phoneSet = {
        bContinuePCSet: !1,
