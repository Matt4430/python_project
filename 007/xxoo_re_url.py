...
def get_video(ye,url):
    url_ping = 'https://www.xvideos.com'
    ...
    with open("url.txt","a",encoding="utf-8") as f:
        page_cont = driver.page_source
        print(page_cont)
        lis_id_div = driver.find_element_by_class_name('mozaique cust-nb-cols')
        for i in lis_id_div:
            a = i.xpath("//div/div/div/a/href()")
            print(a)
        # /video56922827/japanese_schoolgal_misaki_asuka_got_fucked_uncensored
        # https://www.xvideos.com/video56922827/japanese_schoolgal_misaki_asuka_got_fucked_uncensored
    #     for i in range(1, 28):
...
if __name__ == '__main__':
    url = 'https://www.xvideos.com/?k=日本校园'
    ye = 0
    # 定义账号密码
